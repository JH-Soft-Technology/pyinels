...
# get the raw data from the PLC formated in string. Each device is on separated line
# it's just used for developing and data checking purposes
...
# THERM does not have id. You need to use up/down/temp_current/temp_set as param.
# Method is used for getting the state. So this method will be the most offen called one
